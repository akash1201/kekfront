...
exports.createPages = async ({ actions, graphql }) => {
  ...
  const templates = {
    ...
    singleArticles: path.resolve("src/templates/single-blog-post/index.jsx"),
  ...
  try {
    const response = await fetch(
      "https://kekback-dev-build.onrender.com/weapons"
    );
  ...
  try {
    const response = await fetch(
      "https://kekback-dev-build.onrender.com/characters"
    );
    const data = await response.json();
...
// try {
//     const response = await fetch("https://kekback-dev-build.onrender.com/weapons")
